  ...
  return (
    <AuthLayout title="Welcome Back" subtitle="Enter your credentials to access your dashboard">
      <form onSubmit={handleSubmit(onSubmit)} noValidate>
        ...
        <div style={{ marginBottom: 8 * scale }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 6 }}>
            ...
            <span
              ...
              style={{ fontSize: 11 * scale, fontWeight: 700, color: '#8B1A1A', cursor: 'pointer' }}
            >
              Forgot Password?
            </span>
          </div>
          <div style={{ position: 'relative' }}>
            ...
            <span
              ...
              style={{ position: 'absolute', right: 12 * scale, top: '50%', transform: 'translateY(-50%)', cursor: 'pointer', color: '#94a3b8', fontSize: 14 * scale }}
            >
        ...
        <label style={{ display: 'flex', alignItems: 'center', gap: 8, marginTop: 14 * scale, marginBottom: 20 * scale, cursor: 'pointer' }}>
          <input type="checkbox" {...register('remember')} style={{ accentColor: '#8B1A1A', cursor: 'pointer' }} />
          <span style={{ fontSize: 12 * scale, color: '#64748b' }}>Remember me for 30 days</span>
        </label>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, margin: `${22 * scale}px 0` }}>
          <div style={{ flex: 1, height: 1, background: '#E8E0D8' }} />
          <span style={{ fontSize: 10 * scale, fontWeight: 700, letterSpacing: '0.6px', color: '#94a3b8', textTransform: 'uppercase' }}>Or continue with</span>
          <div style={{ flex: 1, height: 1, background: '#E8E0D8' }} />
        </div>
        ...
        <button
          ...
          style={{
            width: '100%', padding: `${10 * scale}px 0`, borderRadius: 8, border: '1px solid #E8E0D8',
            background: '#fff', color: '#334155', fontSize: 13 * scale, fontWeight: 600,
